...
public class GuessNumberHigherorLowerII {
    ...
    * b) similarly, if you start by 3, (the worst case is) if wrong, you get charged $3, then you immediately know that 4 is the target number,
    ...
    * 5, 6 ---------> $5
    * ...
    * for three number, the best strategy is guess the middle number first, and (worst case is) if wrong, you get charged
    * that middle number money, and then you immediately know what target number is by using "lower" or "higher" response, so in summary:
    * range ---------> best strategy cost
    * 3, 4, 5 ---------> $4
    * 7, 8, 9 ---------> $8
    * ...
    ...
    * the worst cost for this is: k+ max(DP( start, k-1 ) , DP(k+1, end )), and the goal is minimize the cost, so you need the minimum one
